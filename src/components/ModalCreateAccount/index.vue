...
export default {
  ...
  setup () {
    ...
    const { value: name, errorMessage: nameErrorMessage } = useField('email', validateEmptyAndLength3)
    const { value: email, errorMessage: emailErrorMessage } = useField('email', validateEmptyAndEmail)
    const { value: password, errorMessage: passwordErrorMessage } = useField('password', validateEmptyAndLength3)
